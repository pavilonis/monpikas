...
VALUES (1, 1, 'Darius Jucys', 'honda', '777', 'darius');

INSERT INTO monpikasdb.User (id, enabled, name, password, phone, username)
VALUES (2, 1, 'Arturas Pavilonis', '417269', '777', 'arturas');

INSERT INTO monpikasdb.User (id, enabled, name, password, phone, username)
VALUES (3, 1, 'Scanner', 'DinnerScan', '777', 'Scanner');
...
INSERT INTO monpikasdb.User_Authority (user_id, authority_id) VALUES (3, 3);